...
namespace au.Applications.PhotoComb {
	/// <summary>
	/// Settings for how PhotoComb is displayed.
	/// </summary>
	public class DisplaySettings {
		/// <summary>
		/// State of the main PhotoComb form.
		/// </summary>
		public FormWindowState WindowState = FormWindowState.Normal;
		/// <summary>
		/// Location of the main PhotoComb form when not maximized or minimized.
		/// </summary>
		public Point Location = new Point(-42, -42);
		/// <summary>
		/// Size of the main PhotoComb form when not maximized or minimized.
		/// </summary>
		public Size Size = new Size(-42, -42);

		/// <summary>
		/// Create a new DisplaySettings object with the default settings.
		/// </summary>
